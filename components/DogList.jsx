...
const DogList = () => {
  return (
    <div className="border">
      <div className="grid grid-cols-3 grid-rows-5 gap-4 overflow-hidden">
        {/* Dog Card */}
        ...
        <div className="border w-auto h-auto min-w-[280px] min-h-[378px] top-[999px] left-[430px] rounded-xl p-2 gap-2 bg-[#FDFDFD]">
          <div className="border w-[264px] h-[264px] rounded-[10px] bg-[#FFFFFF]"></div>
          <div className="border w-auto h-auto min-w-[264px] min-h-[98px] pt-2 pr-2 pb-5 pl-2 gap-4"></div>
        </div>
        {/* .... */}
        {/* Dog Card */}
        <div className="border w-auto h-auto min-w-[280px] min-h-[378px] top-[999px] left-[430px] rounded-xl p-2 gap-2 bg-[#FDFDFD]">

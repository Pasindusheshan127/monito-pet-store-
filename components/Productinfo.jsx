...
const Productinfo = () => {
  return (
    <div className="">
      ...
      <div className="md:mx-[130px]">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 min-w-[1180px] h-auto min-h-[826px] rounded-[20px] md:py-[22px] md:px-[20px] gap-[190px] md:gap-[34px] border border-[#EBEEEF] bg-[#FDFDFD] ">
          {/* Image Carousel */}
          <div className="w-[414px] h-[523px] md:w-full md:min-w-[560px] md:h-auto md:min-h-[706px] gap-4">
            <PetsImageSlider />
            <div className="hidden md:flex w-full h-auto min-h-[48px] min-w-[560px] rounded-[10px] justify-between py-[9px] px-[12px]  mt-4">
            ...
            {/* Icons */}
            <div className="hidden md:flex w-auto min-w-[240px] h-[40px] py-[6px] px-[10px] gap-[21px] ">
              {/* share */}
          ...
          {/* Product Information */}
          <div className="w-[414px] h-auto min-h-[207px] pl-[11px] md:p-0 md:h-auto md:w-auto md:min-w-[517px] md:min-h-[782px] gap-[18px]">
            ...
            <div className="flex mt-5 w-auto h-auto min-h-[44px] min-w-[373px] gap-[18px]">
              <button className="w-auto h-full min-w-[133px] min-h-[48px] md:min-w-[138px] md:min-h-[44px] pt-[12px] px-[28px] pb-[12px] rounded-[57px] bg-[#003459] ">
                <div className="w-[82px] h-6 font-[700] text-[16px] leading-6 text-[#FDFDFD]">
                  Contact us
                </div>
              </button>
              <button className="flex w-auto min-w-[233px] min-h-[48px]  md:min-w-[217px] h-[44px] pt-[10px] px-[28px] pb-[10px] rounded-[57px] border-2 border-[#003459] gap-[18px]">
            ...
            {/*  */}
            <div className="flex-col md:hidden w-full h-auto min-h-[48px] min-w-[382px] rounded-[10px] justify-between py-[9px] px-[12px]  mt-4 bg-[#FCEED5]">
              <div className="flex w-auto h-auto min-w-[244px] min-h-[30px] gap-[9px]">
                <div className="w-[20px] h-[20px] border"></div>
                <div className="w-[225px] h-[20px] font-[700] text-[14px] leading-5 text-[#002A48]">
                  100% health guarantee for pets
